...
const EPAULES: Seed[] = [
  ...
  ['elev-lat-banc-incline', 'Élévations latérales banc incliné 45°', ['épaules'], 'haltères', 'isolation', 1, 90, false, ['incline lateral raise']],
  ...
  ['oiseau-poulie-uni', 'Oiseau poulie unilatéral', ['épaules'], 'poulie', 'isolation', 1, 90],
...
const TRICEPS: Seed[] = [
  ...
  ['skull-crusher-incline', 'Barre au front EZ banc incliné', ['triceps'], 'barre', 'isolation', 2.5, 90, false, ['skull crusher incliné']],
...
const MOBILITE: Seed[] = [
  ...
  ['etirement-trapezes', 'Étirement des trapèzes', ['mobilité'], 'poids du corps', 'mobilité', 1, 30, true],
  ['rotation-epaules-uni', 'Rotations d’épaules unilatérales', ['mobilité'], 'poids du corps', 'mobilité', 1, 30, true, ['cercles épaules']],
  ['montee-genoux', 'Montées de genoux', ['mobilité'], 'poids du corps', 'mobilité', 1, 30, true, ['high knees']],
  ['talons-fesses', 'Talons-fesses', ['mobilité'], 'poids du corps', 'mobilité', 1, 30, true, ['butt kicks']],
  ['balancement-jambes', 'Balancements de jambe', ['mobilité'], 'poids du corps', 'mobilité', 1, 30, true, ['leg swings']],
